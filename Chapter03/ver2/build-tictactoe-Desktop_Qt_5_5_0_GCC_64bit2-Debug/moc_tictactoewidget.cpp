...
#include "../../ver3/tictactoe/tictactoewidget.h"
...
QT_MOC_LITERAL(5, 54, 17), // "handleButtonClick"
...
void TicTacToeWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TicTacToeWidget::currentPlayerChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (TicTacToeWidget::*_t)(Player );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TicTacToeWidget::gameOver)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject TicTacToeWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TicTacToeWidget.data,
      qt_meta_data_TicTacToeWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
